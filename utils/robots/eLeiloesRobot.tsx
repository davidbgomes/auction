...
export const eLeiloesRobot = async () => {
  ...
  for (const houseTypeValue of houseTypeValues) {
    ...
    switch (houseTypeValue) {
      case "1":
        console.log("Starting Scrapping Apartments...");
        break;
      case "2":
        console.log("Starting Scrapping Houses...");
        break;
    }
    ...
    progressBar.start(houseItems.length, 0);
