    ...
    <Container maxW="container.xl">
      ...
      >
        <GridItem rowSpan={2} colSpan={1} display={{base:"none", lg:"initial"}}>
          <Box py="20" px="6" borderRadius="xl" borderWidth="thin" boxShadow="md">
            <SkeletonText mt="4" noOfLines={6} spacing="20"/>
            <HStack pt="20" spacing="4">
              <Button isDisabled bgColor="gray.100">Limpar</Button>
              <Button isDisabled bgColor="gray.200">Filtrar</Button>
            </HStack>
          </Box>
        </GridItem>
