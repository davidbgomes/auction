  ...
  const InfoCard = ({title}:{title: string}) : JSX.Element => {
    return(
      <Box d="flex" alignItems="center">
        ...
        <Heading fontSize={{base: "lg", md: "xl", lg:"2xl"}} fontWeight="light">{title}</Heading>
      </Box>
    )
  }
      ...
      <Container maxW="container.xl">
        <SimpleGrid columns={{base:1, md:2}}>
          <VStack spacing="6" pos="relative" alignItems={{ base: "center", md:"flex-start"}} textAlign={{ base: "center", md:"initial"}} mt={{base:"10", md:"inherit"}} order={{base:2, md:1}}>
            <Heading as="h2" fontSize={{base: "3xl", md:"3xl", lg: "4xl", xl:"5xl"}}>Sobre Nós</Heading>
          ...
          <Box ml={{base: "initial", md: "10"}} order={{base:1, md:2}}>
            <VStack alignItems="flex-start" maxW="fit-content" m="auto" spacing={8}>
              <Heading as="h2" fontSize={{base: "3xl", md:"3xl", lg: "4xl", xl:"5xl"}} w="full" textAlign="center">Vantagens</Heading>
